 ...
 * Project: Implement GroupJoin Operator in SimpleDB
 * GroupJoinTest.java
 * Purpose: Implement the following SQL query with Relational Algebra operators in SimpleDB:
 * SELECT s.SId, COUNT(e.StudentId) AS cnt
 * FROM Student s
 * LEFT JOIN enroll e ON s.SId = e.StudentId
 * GROUP BY s.SId;
 *
 * Author: Wei Liu, Puja Chowdhury
*/
